...
<@layout.registrationLayout; section>
    ...
    <#elseif section = "form">
        <div class="ve-card ve-card--wide">
            ...
            <form id="kc-register-form" class="ve-form" action="${url.registrationAction}" method="post" novalidate>
                <div class="ve-form__row">
                    <div class="ve-field">
                        <label class="ve-field__label" for="firstName">${msg("firstName")}</label>
                        <div class="ve-field__input-wrap">
                            <input id="firstName" class="ve-field__input" type="text" name="firstName" autofocus
                                   value="${register.formData.firstName!''}" placeholder="${msg('firstName')}" aria-label="${msg('firstName')}"/>
                        </div>
                    </div>
                    <div class="ve-field">
                        <label class="ve-field__label" for="lastName">${msg("lastName")}</label>
                        <div class="ve-field__input-wrap">
                            <input id="lastName" class="ve-field__input" type="text" name="lastName"
                                   value="${register.formData.lastName!''}" placeholder="${msg('lastName')}" aria-label="${msg('lastName')}"/>
                        </div>
                    </div>
                </div>

                <div class="ve-field">
                    <label class="ve-field__label" for="email">${msg("email")}</label>
                    <div class="ve-field__input-wrap">
                        <svg class="ve-field__icon" viewBox="0 0 20 20" fill="currentColor" width="18" height="18">
                            <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                            <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
                        </svg>
                        <input id="email" class="ve-field__input" type="text" name="email" autocomplete="email"
                               value="${register.formData.email!''}" placeholder="${msg('email')}" aria-label="${msg('email')}"/>
                    </div>
                </div>

                <#if !realm.registrationEmailAsUsername>
                    <div class="ve-field">
                        <label class="ve-field__label" for="username">${msg("username")}</label>
                        <div class="ve-field__input-wrap">
                            <svg class="ve-field__icon" viewBox="0 0 20 20" fill="currentColor" width="18" height="18">
                                <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/>
                            </svg>
                            <input id="username" class="ve-field__input" type="text" name="username" autocomplete="username"
                                   value="${register.formData.username!''}" placeholder="${msg('username')}" aria-label="${msg('username')}"/>
                        </div>
                    </div>
                </#if>
                ...
                <div class="ve-form__row">
                    <div class="ve-field">
                        ...
                        <div class="ve-field__input-wrap">
                            ...
                            <input id="password" class="ve-field__input" type="password" name="password" autocomplete="new-password"
