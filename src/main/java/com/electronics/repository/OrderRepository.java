...
public interface OrderRepository extends JpaRepository<Order, Integer> {
    ...
    @Query("""
        ...
        """)
    Page<Order> findByMerchantKeycloakId(@Param("keycloakId") String keycloakId, Pageable pageable);
    ...
    @Query("""
        ...
        """)
    BigDecimal sumRevenueByMerchant(@Param("keycloakId") String keycloakId);
